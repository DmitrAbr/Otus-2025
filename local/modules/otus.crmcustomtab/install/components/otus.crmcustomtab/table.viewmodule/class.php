...
use Otus\Crmcustomtab\Orm\BookModuleTable as BookTable;
use Otus\Crmcustomtab\Orm\AuthorModuleTable as AuthorTable;
...
{
	protected $request;
	protected const GRID_ID = 'book_author';
	...
	public function executeComponent()
	{
		try
		{
			...
			$this->fillGridInfo();
			$this->fillGridData();
			$this->arResult['COUNT'] = BookTable::getCount();
